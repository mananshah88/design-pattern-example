package com.pattern.chassis.config.maria.primary;
...
public class PrimaryMariaDBConfig {
    ...
    public DataSourceProperties primaryDataSourceProperties() {
    	System.out.println("In PrimaryMariaDBConfig::primaryDataSourceProperties()::");
    ...
    public DataSource primaryDataSource(@Qualifier("primaryDataSourceProperties") DataSourceProperties primaryDataSourceProperties) {
    	System.out.println("In PrimaryMariaDBConfig::primaryDataSource()::");
    ...
    public LocalContainerEntityManagerFactoryBean primaryEntityManagerFactory(
    	...
    	System.out.println("In PrimaryMariaDBConfig::primaryEntityManagerFactory()::");
    ...
    public PlatformTransactionManager primaryTransactionManager(
    	...
    	System.out.println("In PrimaryMariaDBConfig::primaryTransactionManager()::");
